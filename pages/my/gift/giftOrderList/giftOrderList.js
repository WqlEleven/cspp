...
Page({
  ...
  getOrderList: function (status = null) {
    ...
    var that = this
    wx.request({
      url: app.globalData.config.host + '/home/package_order_list',
      method: 'post',
  ...
  showOrder: function (e) {
    ...
    wx.navigateTo({
      url: '/pages/my/gift/giftOrderDetail/giftOrderDetail?id=' + id
    })
  },
  ...
  goToPay: function (e) {
    var id = e.currentTarget.id
    wx.navigateTo({
      url: '/pages/my/gift/giftPay/giftPay?id=' + id + '&repay=1'
    })
  },
  home: function () {
    wx.switchTab({
